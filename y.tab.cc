...
{
       0,    50,    50,    53,    55,    59,    59,    67,    73,    82,
      89,    97,   106,   113,   116,   123,   124,   128,   131,   137,
     138,   142,   148,   159,   167,   175,   176,   180,   185,   193,
     207,   192,   233,   244,   233,   262,   275,   262
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "WORD", "WORD2",
  "NOTOKEN", "GREAT", "GREATGREAT", "GREATAMPERSAND",
  "GREATGREATAMPERSAND", "AMPERSAND", "PIPE", "LESS", "NEWLINE", "IF",
  "FI", "THEN", "LBRACKET", "RBRACKET", "SEMI", "DO", "DONE", "WHILE",
  "FOR", "IN", "TWOGREAT", "$accept", "goal", "arg_list", "cmd_and_args",
  "$@1", "pipe_list", "io_modifier", "io_modifier_list",
  "background_optional", "SEPARATOR", "command_line", "command_list",
  "if_command", "$@2", "$@3", "while_command", "$@4", "$@5", "for_command",
  "$@6", "$@7", YY_NULLPTR
};
...
{
      71,    16,   -23,   -23,   -15,   -23,   -14,     8,    12,   -23,
       9,   -23,   -23,     4,    16,    16,    16,   -23,   -23,   -23,
     -23,   -23,   -23,    27,    89,   -23,   -23,   -23,   -23,    31,
     -23,   -23,    14,   -23,    33,    36,    40,    42,   -23,    47,
      48,   -23,    16,   -23,     7,    10,   -23,   -23,   -23,   -23,
     -23,   -23,   -23,   -23,    44,    49,     3,    45,    32,    39,
     -23,   -23,   -23,    71,    71,    71,    18,    43,    57,   -23,
     -23,   -23
};
...
static const yytype_int8 yydefact[] =
{
      ...
      32,    35,     1,     0,    18,    28,    22,    23,    24,     6,
       4,     4,     0,     8,     0,     0,     0,     0,    17,     0,
       0,    15,     0,     3,     0,     0,     4,    10,     9,    12,
      11,    13,    14,    21,     0,     0,     0,     0,     0,     0,
      30,    33,    36,     0,     0,     0,     0,     0,     0,    31,
      34,    37
};
...
{
     -23,   -23,   -22,    46,   -23,   -23,   -23,   -23,   -23,     0,
     -13,   -16,   -23,   -23,   -23,   -23,   -23,   -23,   -23,   -23,
     -23
};
...
{
      25,    17,    19,    20,    -2,     1,    43,     2,    44,    45,
      43,    21,    22,    43,    26,    27,    28,     3,     4,     1,
      23,     2,    59,     5,    56,    54,     6,     7,    55,     3,
       2,     3,     4,    69,    43,     5,    47,     5,    46,    48,
       6,     7,    53,    49,     1,    50,     2,    66,    67,    68,
      51,    52,    61,    25,    25,    25,     3,     4,     1,    62,
       2,    60,     5,    57,    70,     6,     7,     0,    58,    33,
       3,     4,     1,     0,     2,     0,     5,     0,    71,     6,
       7,     0,     0,     0,     3,     4,     0,     0,     0,     0,
       5,     0,     0,     6,     7,    34,    35,    36,    37,    38,
...
{
      13,     1,    17,    17,     0,     1,     3,     3,    30,    31,
       3,     3,     0,     3,    14,    15,    16,    13,    14,     1,
      11,     3,    19,    19,    46,    18,    22,    23,    18,    13,
       3,    13,    14,    15,     3,    19,     3,    19,    24,     3,
      22,    23,    42,     3,     1,     3,     3,    63,    64,    65,
       3,     3,    20,    66,    67,    68,    13,    14,     1,    20,
       3,    16,    19,    19,    21,    22,    23,    -1,    19,    23,
      13,    14,     1,    -1,     3,    -1,    19,    -1,    21,    22,
      23,    -1,    -1,    -1,    13,    14,    -1,    -1,    -1,    -1,
      19,    -1,    -1,    22,    23,     6,     7,     8,     9,    10,
...
static const yytype_int8 yystos[] =
{
      ...
      31,    35,    36,    37,    38,    41,    44,    35,    30,    17,
      17,     3,     0,    11,    33,    36,    35,    35,    35,    28,
      39,    42,    45,    29,     6,     7,     8,     9,    10,    12,
      25,    32,    34,     3,    28,    28,    24,     3,     3,     3,
       3,     3,     3,    35,    18,    18,    28,    19,    19,    19,
      16,    20,    20,    40,    43,    46,    37,    37,    37,    15,
      21,    21
};
...
#line 193 "shell.y"
      ...
      Shell::TheShell->_ifCommand->isFor = false;
	}
#line 1371 "y.tab.cc"
    break;
...
#line 262 "shell.y"
     ...
     if (Shell::TheShell->_level > 0) {
      ...
      Shell::TheShell->_ifCommand->loop_var = *(yyvsp[0].cpp_string);
...
#line 1476 "y.tab.cc"
  ...
  case 37: /* for_command: FOR WORD $@6 IN arg_list SEMI DO $@7 command_list DONE  */
#line 280 "shell.y"
                        {
      Shell::TheShell->_level--; 
      Shell::TheShell->_ifCommand->insertListCommands(Shell::TheShell->_listCommands);
